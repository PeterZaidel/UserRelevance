...
//        public double mean_click_time = 0;
    ...
    private String reducer_final_mean_pos(MutableBoolean isNotZero)
    {
    ...
    public ReduceResult reduce_final(Text key, Reducer.Context context) throws IOException, InterruptedException {
        ...
        String mean_pos = reducer_final_mean_pos(isNotZero);

        String[] outValues = {click_count, shows_count, mean_pos};
